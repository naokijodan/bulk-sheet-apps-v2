...
var PROMPT_TAG_MAPPING = {
  ...
  'アパレル・ブランド品': ['衣類','服','帽子','キャップ','スカーフ','マフラー','ストール','ショール','バンダナ','スヌード','ネックウォーマー','ベルト','ベルトバックル','ネクタイ','蝶ネクタイ','ボウタイ','アスコットタイ','ネクタイピン','タイピン','タイバー','スカーフリング','ハンカチ','ポケットチーフ','タオルハンカチ','ヘアアクセサリー','バレッタ','かんざし','髪飾り'],
  'レザーグッズ': ['バッグ','財布','長財布','二つ折り財布','三つ折り財布','ミニ財布','コインケース','カードケース','キーケース','パスケース','マネークリップ','札入れ','がま口','手帳カバー'],
