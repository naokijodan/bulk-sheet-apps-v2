...
var PROMPT_TAG_MAPPING = {
  ...
  '日本伝統・骨董': ['茶道具','茶碗','鉄瓶','急須','南部鉄器','仏像','仏具','仏教美術','神具','木彫','銅像','観音','如来','数珠','木魚','陶磁器','陶器','磁器','焼物','香炉','花瓶','壺','有田焼','伊万里','古伊万里','九谷焼','備前焼','萩焼','信楽焼','瀬戸焼','美濃焼','唐津焼','京焼','清水焼','織部','志野','薩摩焼','茶入','棗','茶杓','水指','建水','風炉','釜','蓋置','香合','花入','茶筅','柄杓','菓子器','炉縁','盆栽','盆栽鉢','盆器','水石','盆栽道具','盆栽ハサミ','飾台','卓','水盤'],
  'アート': ['絵画','油絵','水彩画','日本画','水墨画','墨絵','アクリル画','パステル画'],
  '掛軸': ['掛軸','掛け軸','床掛け'],
  '版画': ['浮世絵','版画','木版画','リトグラフ','シルクスクリーン','エッチング','銅版画','新版画','創作版画'],
  'パイプ・喫煙具': ['パイプ','喫煙パイプ','煙管','キセル','パイプ・喫煙具'],
  'テーブルウェア': ['皿','プレート','食器','茶碗','カップ','グラス','ワイングラス','クリスタル','カトラリー','スプーン','フォーク','切子','ボウル','マグカップ','ティーカップ','ソーサー','ティーポット','鉢','ガラス細工','江戸切子','薩摩切子','デキャンタ','ペーパーウェイト','銀食器','シルバーカトラリー'],
