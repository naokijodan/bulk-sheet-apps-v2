...
// lure: ルアー・釣具
SANITIZE_CATEGORIES.lure = {
  keywords: ['ルアー', 'ミノー', 'クランクベイト', 'ワーム', 'メタルジグ',
    'エギ', 'スプーン', 'ジグ', 'トップウォーター', 'ソフトベイト',
    'スピナーベイト', 'バイブレーション', 'フロッグ', 'タックル']
};
...
var PROMPT_TAG_MAPPING = {
  '時計用': ['時計','腕時計','ウォッチ','懐中時計','置き時計','時計パーツ','ウォッチパーツ','時計部品'],
  'カメラ': ['カメラ','デジカメ','一眼レフ','ミラーレス','レンズ'],
  'リール': ['リール', '電動リール', 'スピニングリール', 'ベイトリール', '両軸リール', 'フライリール', 'フィッシングリール'],
  '釣竿': ['釣竿','ロッド','竿', 'ジギングロッド', 'エギングロッド', 'テンカラ', 'シーバスロッド', 'アユロッド', '渓流竿'],
  '釣具汎用': ['ルアー','ルアーミノー','ルアークランクベイト','ルアーワーム','ルアーメタルジグ','ルアーエギ','ルアースプーン','ルアージグ','ルアートップウォーター','ルアーソフトベイト','ルアースピナーベイト','ルアーバイブレーション','ルアーフロッグ','ルアータックル'],
  'ゴルフ': ['ゴルフ','ゴルフクラブ','ゴルフヘッド','ドライバー','アイアン','パター','ウェッジ'],
  'ジュエリー': ['ネックレス','リング','指輪','リング・指輪','ペンダント','チェーン','ブレスレット','バングル','ピアス','イヤリング','ピアス・イヤリング','ブローチ','カフリンクス','カフリンク','カフスボタン','チャーム','ペンダントトップ'],
  'ポケカ': ['ポケカ','ポケモンカード'],
  'MTG': ['MTG','マジックザギャザリング'],
  ...
  'デジモンカード': ['デジモン','デジモンカード'],
  'ガンダムカード': ['ガンダムカード','ガンダムウォー','アーセナルベース','ガンダムクロスウォー','カードダス'],
  'トレカ汎用': ['ヴァンガード','デュエマ','デュエルマスターズ','バトスピ','バトルスピリッツ','トレカ','カード','トレーディングカード','PSA','BGS','CGC','SGC'],
  'ゲーム用': ['ゲーム','ゲームソフト','ゲーム　中古','ゲーム　新品','テレビゲーム','ゲームソフトPS5','ゲームソフトPS4','ゲームソフトPS3','ゲームソフトPS2','ゲームソフトSwitch','ゲームソフトXbox','ゲームソフトファミコン','ゲームソフトスーファミ','ゲームソフトゲームボーイ','ゲームソフトNintendo','ゲームソフトPlayStation'],
  'ゲーム機': ['ゲーム機','ゲーム本体','コンソール','プレステ','PS1','Wii','ドリームキャスト','サターン','メガドライブ','PCエンジン','ネオジオ','ゲームキューブ','Nintendo 64','N64','DS','3DS','PSP','PSVita','Steam Deck','ゲーム機PS5','ゲーム機PS4','ゲーム機PS3','ゲーム機PS2','ゲーム機Switch','ゲーム機Xbox','ゲーム機ファミコン','ゲーム機スーファミ','ゲーム機ゲームボーイ','ゲーム機Nintendo','ゲーム機PlayStation','コントローラー','ジョイスティック','メモリーカード','ゲーム周辺機器','アーケードスティック','ゲームパッド','AVケーブル','HDMIケーブル'],
  'コレクティブル': ['アンティーク','ヴィンテージ','骨董品','コレクティブル','昭和レトロ','レトロ','当時物','ブリキ','ソフビ','ノベルティ','非売品','デッドストック','景品','ピンバッジ','ミリタリー','鉄道グッズ','記念品','紙もの','けん玉','ケンダマ','剣玉','独楽','コマ','こま'],
  'フィギュア': ['フィギュア','アクションフィギュア','ドール','ぬいぐるみ','人形','テディベア','プーリップ','ブライス','ドルフィー','BJD','バービー','リカちゃん','ベアブリック','シュタイフ','ジェリーキャット','スクイッシュマロ','モンチッチ','スタチュー'],
  'アニメ': ['アニメ','アニメグッズ','アクスタ','缶バッジ','タペストリー','クリアファイル','色紙','ラバスト','ポスター','セル画','原画','ブロマイド','キーホルダー'],
  '漫画': ['漫画','マンガ','コミック','単行本','文庫本','全巻セット','初版','同人誌','画集'],
  'スニーカー': ['スニーカー'],
  'ドレスシューズ': ['靴','シューズ','ブーツ','サンダル','パンプス','ローファー'],
  'アパレル・ブランド品': ['衣類','服','トップス','ボトムス','ジャケット','コート','ドレス','スカート','パンツ','帽子','キャップ','ハット','ビーニー','バケットハット','スナップバック','ベースボールキャップ','トラッカーハット','ニット帽','ベレー帽','フェドーラ','パナマハット','キャスケット','ハンチング','ダッドハット','サンバイザー','スカーフ','マフラー','ストール','ショール','バンダナ','スヌード','ネックウォーマー','ベルト','レザーベルト','メッシュベルト','ベルトバックル','バックル','ネクタイ','蝶ネクタイ','ボウタイ','アスコットタイ','ネクタイピン','タイピン','タイバー','スカーフリング','ハンカチ','ポケットチーフ','タオルハンカチ','ヘアアクセサリー','バレッタ','かんざし','髪飾り'],
  'レザーグッズ': ['バッグ','ハンドバッグ','ショルダーバッグ','トートバッグ','リュック','ボストンバッグ','クラッチバッグ','財布','長財布','二つ折り財布','三つ折り財布','ミニ財布','コインケース','カードケース','キーケース','パスケース','マネークリップ','札入れ','がま口','手帳カバー','キーリング','チャームキーホルダー'],
  'オーディオ・家電': ['オーディオ','家電','ヘッドホン','イヤホン','スピーカー','電子機器','オーディオアンプ','AVアンプ','レシーバー','レコードプレーヤー','カセットデッキ','ウォークマン','DAP','ポータブルプレーヤー','炊飯器','掃除機','ドライヤー','美顔器','電気ケトル','空気清浄機','プロジェクター','ラジオ'],
  '楽器': ['楽器','バイオリン','フルート','サックス','トランペット','ドラム','ハーモニカ','キーボード','シンセサイザー','シンセ','電子ピアノ','ワークステーション','サンプラー','ドラムマシン','グルーヴボックス','DJコントローラー','ターンテーブル','ミキサー','CDJ','管楽器','スネア','シンバル','パーカッション','クラリネット','トロンボーン','チェロ','ビオラ','コントラバス','ウッドベース'],
  '楽器_ギター': ['ギター','エレキギター','アコースティックギター','クラシックギター','ベース','エレキベース','ウクレレ'],
  '楽器_アンプ': ['アンプ','ギターアンプ','ベースアンプ','チューブアンプ','エフェクター','ストンプボックス','マルチエフェクター','ペダル','オーバードライブ','ディストーション','ファズ','ディレイ','リバーブ','コーラス','コンプレッサー','ワウ','ルーパー','ブースター'],
  'RC・模型': ['ラジコン','RC','模型','プラモデル','ミニ四駆','鉄道模型','モデルカー','スケールモデル','戦車','戦闘機'],
  'メカプラモ': ['ガンプラ','HGUC','MG','RG','PG','SD','BB戦士','プレバン','ゾイド','フレームアームズ','メカプラモ','ロボットプラモ'],
  '音楽CD': ['CD','CD　中古','CD　新品'],
  'レコード': ['レコード','LP','EP','カセット'],
  '映像作品': ['DVD','DVD　単品','DVD セット','ブルーレイ','Blu-ray','VHS'],
  'サングラス': ['サングラス','メガネ','眼鏡'],
  ...
  '着物': ['着物','和装','振袖','留袖','訪問着','浴衣','帯','袴','小紋','紬','付下げ','羽織','色無地','反物','草履','下駄','名古屋帯','袋帯','半幅帯'],
  '日本刀': ['日本刀','刀','脇差','短刀','太刀','刀装具','鍔','目貫','拵え','縁頭','小柄','笄'],
  '陶磁器': ['陶磁器','陶器','磁器','焼物','香炉','花瓶','壺','茶碗','有田焼','伊万里','古伊万里','九谷焼','備前焼','萩焼','信楽焼','瀬戸焼','美濃焼','唐津焼','京焼','清水焼','織部','志野','薩摩焼','陶器急須'],
  '茶道具': ['茶道具','茶入','棗','茶杓','水指','建水','風炉','釜','蓋置','香合','花入','茶筅','柄杓','菓子器','炉縁'],
  '鉄瓶': ['鉄瓶','南部鉄器','銀瓶','銅瓶','茶釜','鉄瓶急須'],
  '仏教美術': ['仏像','仏具','仏教美術','神具','木彫','銅像','観音','如来','数珠','木魚'],
  '盆栽': ['盆栽','盆栽鉢','盆器','水石','盆栽道具','盆栽ハサミ','飾台','卓','水盤'],
  '包丁': ['包丁','出刃包丁','刺身包丁','柳刃包丁','三徳包丁','牛刀','菜切包丁','ペティナイフ','和包丁','薄刃包丁'],
  'アート': ['絵画','油絵','水彩画','日本画','水墨画','墨絵','アクリル画','パステル画'],
  '掛軸': ['掛軸','掛け軸','床掛け'],
  '版画': ['浮世絵','版画','木版画','リトグラフ','シルクスクリーン','エッチング','銅版画','新版画','創作版画'],
  'パイプ・喫煙具': ['パイプ','喫煙パイプ','煙管','キセル','パイプ・喫煙具'],
  'テーブルウェア': ['皿','プレート','食器','カップ','グラス','ワイングラス','クリスタル','カトラリー','スプーン','フォーク','切子','ボウル','マグカップ','ティーカップ','ソーサー','ティーポット','鉢','ガラス細工','江戸切子','薩摩切子','デキャンタ','ペーパーウェイト','銀食器','シルバーカトラリー'],
  '和楽器': ['三味線','尺八','琴','太鼓','和太鼓','篠笛','琵琶','鼓','和楽器','雅楽'],
  '切手・コイン': ['切手','記念切手','普通切手','コイン','古銭','硬貨','紙幣','メダル'],
  '石鹸': ['石鹸','せっけん','ソープ','石けん'],
  '日本人形': ['こけし','日本人形','博多人形','市松人形','雛人形','五月人形','木目込み人形','御所人形','伏見人形','からくり人形','土人形','文楽人形','だるま','達磨','ダルマ','招き猫','まねきねこ','招福猫'],
  'スノーグローブ': ['スノードーム','ガラスドーム','スノーグローブ','ウォータードーム'],
  '書籍・雑誌': ['書籍','雑誌','小説','写真集','フォトブック','アートブック','図録','MOOK','ムック','専門誌','文庫','新書','絵本','洋書'],
  '一般商品・汎用': ['ジュエリーボックス','時計ケース','ウォッチボックス','宝石箱','アクセサリーケース','コレクションケース','ディスプレイケース','ベビー','ベビーシューズ','ラトル','ベビー用品','ガラガラ','櫛','くし','コーム','つげ櫛','ヘアコーム'],
  'ボードゲーム': ['将棋','将棋セット','将棋盤','将棋駒','麻雀','麻雀セット','麻雀牌','マージャン','囲碁','囲碁セット','碁盤','碁石','いご','ボードゲーム','卓上ゲーム','アナログゲーム','テーブルゲーム','チェス','バックギャモン','オセロ','リバーシ','ダーツ'],
  'パソコン周辺機器': ['パソコン周辺機器'],
  'パソコン本体': ['パソコン本体'],
  '電子辞書': ['電子辞書'],
  '関数電卓': ['関数電卓'],
  '手工具': ['手工具','カンナ','かんな','鉋','のみ','ノミ','鑿','コテ','こて','鏝','玄能','げんのう','ゲンノウ','鋸','のこぎり','ノコギリ','スパナ','墨壺','すみつぼ','スミツボ','曲尺','かねじゃく','さしがね','プライヤー','ノギス','ヤスリ','やすり','鑢','砥石','といし','トイシ'],
  '電動工具': ['電動工具','インパクト','ドリル','丸ノコ']
};
