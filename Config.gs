...
var PROMPT_TAG_MAPPING = {
  ...
  'ゲーム用': ['ゲーム','ゲームソフト','テレビゲーム','ゲームソフトPS5','ゲームソフトPS4','ゲームソフトPS3','ゲームソフトPS2','ゲームソフトSwitch','ゲームソフトXbox','ゲームソフトファミコン','ゲームソフトスーファミ','ゲームソフトゲームボーイ','ゲームソフトNintendo','ゲームソフトPlayStation'],
  ...
  '電動工具': ['電動工具','インパクト','ドリル','丸ノコ','ジグソー','グラインダー','サンダー','トリマー','ヒートガン','コードレス','充電式']
};
