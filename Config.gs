...
var PROMPT_TAG_MAPPING = {
  ...
  'ゲーム用': ['ゲーム','ゲームソフト','テレビゲーム','Switch','PS5','PS4','PS3','PS2','Xbox','ファミコン','スーファミ','ゲームボーイ','Nintendo','PlayStation'],
  'ゲーム機': ['ゲーム機','ゲーム本体','コンソール','プレステ','PS1','Wii','ドリームキャスト','サターン','メガドライブ','PCエンジン','ネオジオ','ゲームキューブ','Nintendo 64','N64','DS','3DS','PSP','PSVita','Steam Deck','コントローラー','ジョイスティック','メモリーカード','ゲーム周辺機器','アーケードスティック','ゲームパッド','AVケーブル','HDMIケーブル'],
