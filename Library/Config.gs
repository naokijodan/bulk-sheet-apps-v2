...
var PROMPT_TAG_MAPPING = {
  ...
  'アパレル・ブランド品': ['衣類','服','帽子','キャップ','スカーフ','マフラー','ストール','ショール','バンダナ','スヌード','ネックウォーマー','ベルト','レザーベルト','メッシュベルト','ベルトバックル','ネクタイ','蝶ネクタイ','ボウタイ','アスコットタイ','ネクタイピン','タイピン','タイバー','スカーフリング','ハンカチ','ポケットチーフ','タオルハンカチ','ヘアアクセサリー','バレッタ','かんざし','髪飾り'],
