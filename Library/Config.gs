...
var PROMPT_TAG_MAPPING = {
  ...
  'レザーグッズ': ['バッグ','ハンドバッグ','ショルダーバッグ','トートバッグ','リュック','ボストンバッグ','クラッチバッグ','財布','長財布','二つ折り財布','三つ折り財布','ミニ財布','コインケース','カードケース','キーケース','パスケース','マネークリップ','札入れ','がま口','手帳カバー'],
  ...
  '石鹸': ['石鹸','せっけん','ソープ','石けん'],
  '一般商品・汎用': ['スノードーム','ガラスドーム','スノーグローブ','ウォータードーム','ジュエリーボックス','時計ケース','ウォッチボックス','宝石箱','アクセサリーケース','コレクションケース','ディスプレイケース','ベビー','ベビーシューズ','ラトル','ベビー用品','ガラガラ']
};
