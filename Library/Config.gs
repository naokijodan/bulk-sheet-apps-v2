...
var PROMPT_TAG_MAPPING = {
  ...
  'アパレル・ブランド品': ['衣類','服','帽子','キャップ','スカーフ','マフラー','ストール','ショール','バンダナ','スヌード','ネックウォーマー','ベルト','ベルトバックル','ネクタイ','蝶ネクタイ','ボウタイ','アスコットタイ','ネクタイピン','タイピン','ハンカチ','ポケットチーフ','タオルハンカチ','ヘアアクセサリー','バレッタ','かんざし','髪飾り'],
