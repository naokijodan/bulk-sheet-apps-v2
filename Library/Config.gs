...
var PROMPT_TAG_MAPPING = {
  ...
  'コレクティブル': ['アンティーク','ヴィンテージ','骨董品','コレクティブル','昭和レトロ','レトロ','当時物','ブリキ','ソフビ','ノベルティ','非売品','デッドストック','景品','ピンバッジ','ミリタリー','鉄道グッズ','記念品','紙もの'],
  ...
  '石鹸': ['石鹸','せっけん','ソープ','石けん'],
  '日本人形': ['こけし','日本人形','博多人形','市松人形','雛人形','五月人形','木目込み人形','御所人形','伏見人形','からくり人形','土人形','文楽人形'],
