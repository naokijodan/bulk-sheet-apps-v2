...
var PROMPT_TAG_MAPPING = {
  ...
  'RC・模型': ['ラジコン','RC','模型','プラモデル','ミニ四駆','鉄道模型','モデルカー','スケールモデル','戦車','戦闘機','ガンプラ','HGUC','MG','RG','PG','SD','BB戦士','プレバン','ゾイド','フレームアームズ','メカプラモ','ロボットプラモ'],
  ...
  'アート': ['絵画','版画','リトグラフ','油絵','水彩画','木版画','浮世絵','シルクスクリーン','日本画','水墨画','墨絵','アクリル画','パステル画','掛軸','掛け軸','床掛け','エッチング','銅版画','新版画','創作版画'],
