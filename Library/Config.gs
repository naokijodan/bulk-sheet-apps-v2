...
var PROMPT_TAG_MAPPING = {
  ...
  'ゲーム用': ['ゲーム','ゲームソフト','テレビゲーム','Switch','PS5','PS4','PS3','PS2','Xbox','ファミコン','スーファミ','ゲームボーイ','Nintendo','PlayStation','ゲームソフトPS5','ゲームソフトPS4','ゲームソフトPS3','ゲームソフトPS2','ゲームソフトSwitch','ゲームソフトXbox','ゲームソフトファミコン','ゲームソフトスーファミ','ゲームソフトゲームボーイ','ゲームソフトNintendo','ゲームソフトPlayStation'],
  ...
  '楽器': ['楽器','ギター','ベース','ウクレレ','エレキギター','アコースティックギター','クラシックギター','エレキベース','バイオリン','フルート','サックス','トランペット','ドラム','ハーモニカ','キーボード','シンセサイザー','シンセ','電子ピアノ','ワークステーション','サンプラー','ドラムマシン','グルーヴボックス','DJコントローラー','ターンテーブル','ミキサー','管楽器','スネア','シンバル','パーカッション','クラリネット','トロンボーン','チェロ','ビオラ','エフェクター','ストンプボックス','マルチエフェクター','オーバードライブ','ディストーション','ファズ','ディレイ','リバーブ','コーラス','コンプレッサー','ワウ','ルーパー','ブースター','アンプ','ギターアンプ','ベースアンプ'],
