...
var PROMPT_TAG_MAPPING = {
  ...
  'フィギュア': ['フィギュア','アクションフィギュア','ドール','ぬいぐるみ','アニメ','アニメグッズ','アクスタ','缶バッジ','タペストリー','クリアファイル','色紙','ラバスト','ポスター','セル画','原画','ブロマイド','キーホルダー','人形','テディベア','プーリップ','ブライス','ドルフィー','BJD','バービー','リカちゃん','ベアブリック','シュタイフ','ジェリーキャット','スクイッシュマロ','モンチッチ','スタチュー'],
  ...
  '一般商品・汎用': ['スノードーム','ガラスドーム','スノーグローブ','ウォータードーム','ジュエリーボックス','時計ケース','ウォッチボックス','宝石箱','アクセサリーケース','コレクションケース','ディスプレイケース','ベビー','ベビーシューズ','ラトル','ベビー用品','ガラガラ','櫛','くし','コーム','つげ櫛','ヘアコーム']
};
