...
var PROMPT_TAG_MAPPING = {
  ...
  'アパレル・ブランド品': ['衣類','服','トップス','ボトムス','ジャケット','コート','ドレス','スカート','パンツ','帽子','キャップ','ハット','ビーニー','バケットハット','スナップバック','ベースボールキャップ','トラッカーハット','ニット帽','ベレー帽','フェドーラ','パナマハット','キャスケット','ハンチング','ダッドハット','サンバイザー','スカーフ','マフラー','ストール','ショール','バンダナ','スヌード','ネックウォーマー','ベルト','レザーベルト','メッシュベルト','ベルトバックル','ネクタイ','蝶ネクタイ','ボウタイ','アスコットタイ','ネクタイピン','タイピン','タイバー','スカーフリング','ハンカチ','ポケットチーフ','タオルハンカチ','ヘアアクセサリー','バレッタ','かんざし','髪飾り'],
