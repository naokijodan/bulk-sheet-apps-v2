...
var IS_BRAND_DICT = [
  ...
  {name: 'Premier', jp_names: ['プルミエ', 'PREMIER'], country: 'Japan', parent_brand: 'Seiko', category: ['Watches']},
  ...
  {name: 'Tissot T-Touch', jp_names: ['Tタッチ', 'T-TOUCH', 'TTOUCH'], country: 'Switzerland', parent_brand: 'Tissot', category: ['Watches']},
  {name: 'Tissot Tradition', jp_names: ['トラディション', 'TRADITION'], country: 'Switzerland', parent_brand: 'Tissot', category: ['Watches']},
  ...
  {name: 'True', jp_names: ['トゥルー', 'TRUE'], country: 'Switzerland', parent_brand: 'Rado', category: ['Watches']},
