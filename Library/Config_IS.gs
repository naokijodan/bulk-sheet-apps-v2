...
var IS_INITIAL_DATA = [
  ...
  { category: 'Watches', tag_jp: '時計,腕時計,ウォッチ,懐中時計', field_name: 'Wrist Size', field_type: 'recommended', priority: 17, notes: 'cm/inch併記。例: 18cm/7.1in' },
...
,
  ...
  { category: 'Japanese Swords', tag_jp: '日本刀,刀,脇差,短刀,太刀,刀装具,鍔,目貫,縁頭', field_name: 'Color', field_type: 'recommended', priority: 5, notes: '' },
  ...
  { category: 'Golf', tag_jp: 'ゴルフ,ゴルフクラブ,ドライバー,アイアン,パター,ウェッジ', field_name: 'Golf Club Type', field_type: 'required', priority: 3, notes: 'Driver / Iron / Putter / Wedge / Wood / Hybrid' },
  ...
  { category: 'Golf', tag_jp: 'ゴルフ,ゴルフクラブ,ドライバー,アイアン,パター,ウェッジ', field_name: 'Handedness', field_type: 'recommended', priority: 7, notes: 'Right-Handed / Left-Handed' },
  { category: 'Golf', tag_jp: 'ゴルフ,ゴルフクラブ,ドライバー,アイアン,パター,ウェッジ', field_name: 'Country/Region of Manufacture', field_type: 'recommended', priority: 8, notes: '' },
  ...
  { category: 'Baseball', tag_jp: '野球,グローブ,グラブ,バット,ミット', field_name: 'Handedness', field_type: 'recommended', priority: 4, notes: 'Right-Hand Throw / Left-Hand Throw' },
  ...
  { category: 'Coins', tag_jp: 'コイン,古銭,硬貨,紙幣,メダル', field_name: 'Country/Region of Manufacture', field_type: 'recommended', priority: 6, notes: '' },
  ...
  { category: 'Records', tag_jp: 'レコード,LP,EP,シングル,CD,カセット', field_name: 'Record Size', field_type: 'recommended', priority: 4, notes: '7" / 10" / 12"' },
  ...
  { category: 'Records', tag_jp: 'レコード,LP,EP,シングル,CD,カセット', field_name: 'Record Grading', field_type: 'recommended', priority: 7, notes: 'Mint / Near Mint / Very Good Plus等' },
...
var IS_CATEGORY_FIELDS = {
  ...
  'Kimono':              ['Brand', 'Type', 'Material', 'Color', 'Style', 'Season', 'Size', 'Country/Region of Manufacture'],
  'Japanese Swords':     ['Type', 'Blade Material', 'Original/Reproduction', 'Handedness', 'Material', 'Country/Region of Manufacture'],
  'Tea Ceremony':        ['Type', 'Material', 'Maker', 'Style', 'Country/Region of Manufacture'],
  'Bonsai':              ['Type', 'Material', 'Size', 'Color', 'Shape', 'Country/Region of Manufacture'],
  'Prints':              ['Listed By', 'Medium', 'Subject', 'Maker', 'Style', 'Size', 'Country/Region of Manufacture'],
  ...
  'Golf':                ['Brand', 'Type', 'Golf Club Type', 'Shaft Material', 'Flex', 'Loft', 'Handedness', 'Country/Region of Manufacture'],
  'Tennis':              ['Brand', 'Type', 'Head Size', 'Grip Size', 'String Pattern', 'Weight', 'Country/Region of Manufacture'],
  'Baseball':            ['Brand', 'Type', 'Player Position', 'Handedness', 'Size', 'Material', 'Country/Region of Manufacture'],
  'Japanese Instruments': ['Type', 'Material', 'Size', 'Country/Region of Manufacture'],
  'Fishing Rods':        ['Brand', 'Model', 'Rod Type', 'Item Length', 'Rod Power', 'Rod Action', 'Fishing Type', 'Fish Species', 'Country/Region of Manufacture'],
  ...
  'Stamps':              ['Certification', 'Type', 'Year of Issue', 'Topic', 'Quality', 'Country/Region of Manufacture'],
  'Coins':               ['Certification', 'Denomination', 'Year', 'Composition', 'Grade', 'Country/Region of Manufacture'],
  'Records':             ['Artist', 'Format', 'Genre', 'Record Size', 'Record Label', 'Edition', 'Record Grading', 'Country/Region of Manufacture']
};
