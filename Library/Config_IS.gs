...
var IS_BRAND_DICT = [
  ...
  {name: 'Microsoft Xbox', jp_names: ['エックスボックス', 'Xbox', 'XBOX', 'マイクロソフト'], country: 'United States', category: ['Video Games']},
  {name: 'Atari', jp_names: ['アタリ', 'ATARI'], country: 'United States', category: ['Video Games']},
  ...
  {name: 'Commodore', jp_names: ['コモドール', 'COMMODORE'], country: 'United States', category: ['Video Games']},
  {name: 'Coleco', jp_names: ['コレコ', 'COLECO', 'COLECOVISION'], country: 'United States', category: ['Video Games']},
  {name: 'Mattel', jp_names: ['マテル', 'MATTEL', 'INTELLIVISION'], country: 'United States', category: ['Video Games']},
  {name: 'Valve', jp_names: ['バルブ', 'VALVE', 'STEAM DECK'], country: 'United States', category: ['Video Games']},
  {name: 'Analogue', jp_names: ['アナログ', 'ANALOGUE'], country: 'United States', category: ['Video Games']},
  {name: 'Retro-Bit', jp_names: ['レトロビット', 'RETRO-BIT', 'RETROBIT'], country: 'United States', category: ['Video Games']},
  {name: 'Hyperkin', jp_names: ['ハイパーキン', 'HYPERKIN'], country: 'United States', category: ['Video Games']},
  ...
  {name: 'Magnavox', jp_names: ['マグナボックス', 'MAGNAVOX'], country: 'United States', category: ['Video Games']},
  ...
  {name: 'Playdate', jp_names: ['プレイデート', 'PLAYDATE'], country: 'United States', category: ['Video Games']},
  {name: 'Evercade', jp_names: ['エバーケード', 'EVERCADE'], country: 'United Kingdom', category: ['Video Games']},
  ...
  {name: 'Tiffany & Co.', jp_names: ['ティファニー', 'TIFFANY', 'TIFFANY&CO'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Cartier', jp_names: ['カルティエ', 'CARTIER'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Bvlgari', jp_names: ['ブルガリ', 'BVLGARI', 'BULGARI'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Van Cleef & Arpels', jp_names: ['ヴァンクリーフ', 'ヴァンクリーフアンドアーペル', 'VAN CLEEF', 'VCA'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Harry Winston', jp_names: ['ハリーウィンストン', 'HARRY WINSTON'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Hermes', jp_names: ['エルメス', 'HERMES'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Chanel', jp_names: ['シャネル', 'CHANEL'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Louis Vuitton', jp_names: ['ルイヴィトン', 'LOUIS VUITTON', 'LV'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Gucci', jp_names: ['グッチ', 'GUCCI'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Dior', jp_names: ['ディオール', 'DIOR', 'CHRISTIAN DIOR'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Boucheron', jp_names: ['ブシュロン', 'BOUCHERON'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Chaumet', jp_names: ['ショーメ', 'CHAUMET'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Piaget', jp_names: ['ピアジェ', 'PIAGET'], country: 'Switzerland', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Chopard', jp_names: ['ショパール', 'CHOPARD'], country: 'Switzerland', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Graff', jp_names: ['グラフ', 'GRAFF'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Fred', jp_names: ['フレッド', 'FRED'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Damiani', jp_names: ['ダミアーニ', 'DAMIANI'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Pomellato', jp_names: ['ポメラート', 'POMELLATO'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Mikimoto', jp_names: ['ミキモト', 'MIKIMOTO'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'TASAKI', jp_names: ['タサキ', '田崎真珠', '田崎', 'TASAKI'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Star Jewelry', jp_names: ['スタージュエリー', 'STAR JEWELRY'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: '4°C', jp_names: ['ヨンドシー', '4℃', '4°C', '4度C'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Vendome Aoyama', jp_names: ['ヴァンドーム青山', 'ヴァンドームアオヤマ', 'VENDOME AOYAMA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'AHKAH', jp_names: ['アーカー', 'AHKAH'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'agete', jp_names: ['アガット', 'AGETE'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'ete', jp_names: ['エテ', 'ETE'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Nojess', jp_names: ['ノジェス', 'NOJESS'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Ponte Vecchio', jp_names: ['ポンテヴェキオ', 'PONTE VECCHIO'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'K.uno', jp_names: ['ケイウノ', 'K.UNO', 'KUNO'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'I-PRIMO', jp_names: ['アイプリモ', 'I-PRIMO', 'IPRIMO'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'NIWAKA', jp_names: ['にわか', '俄', 'NIWAKA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Ginza Tanaka', jp_names: ['ギンザタナカ', '田中貴金属', 'GINZA TANAKA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Wako', jp_names: ['和光', 'WAKO'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Kashikey', jp_names: ['カシケイ', 'KASHIKEY'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Hirotaka', jp_names: ['ヒロタカ', 'HIROTAKA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Tsutsumi', jp_names: ['ツツミ', 'ジュエリーツツミ', 'TSUTSUMI'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Estelle', jp_names: ['エステール', 'ESTELLE', 'AS-ME ESTELLE'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Swarovski', jp_names: ['スワロフスキー', 'SWAROVSKI'], country: 'Austria', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Pandora', jp_names: ['パンドラ', 'PANDORA'], country: 'Denmark', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Georg Jensen', jp_names: ['ジョージジェンセン', 'GEORG JENSEN'], country: 'Denmark', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Chrome Hearts', jp_names: ['クロムハーツ', 'CHROME HEARTS'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'David Yurman', jp_names: ['デヴィッドユーマン', 'DAVID YURMAN'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'John Hardy', jp_names: ['ジョンハーディ', 'JOHN HARDY'], country: 'Indonesia', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Vivienne Westwood', jp_names: ['ヴィヴィアンウエストウッド', 'VIVIENNE WESTWOOD'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Bottega Veneta', jp_names: ['ボッテガヴェネタ', 'BOTTEGA VENETA'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Celine', jp_names: ['セリーヌ', 'CELINE'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Mauboussin', jp_names: ['モーブッサン', 'MAUBOUSSIN'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Korloff', jp_names: ['コルロフ', 'KORLOFF'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},

  // === Jewelry (Additional) ===
  {name: 'goro\'s', jp_names: ['ゴローズ', 'GOROS', 'GORO\'S'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'LONE ONES', jp_names: ['ロンワンズ', 'LONE ONES', 'レナードカムホート'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Justin Davis', jp_names: ['ジャスティンデイビス', 'JUSTIN DAVIS'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Royal Order', jp_names: ['ロイヤルオーダー', 'ROYAL ORDER'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Gaboratory', jp_names: ['ガボラトリー', 'ガボール', 'GABORATORY', 'GABOR'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Bill Wall Leather', jp_names: ['ビルウォールレザー', 'BWL', 'BILL WALL LEATHER'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Loree Rodkin', jp_names: ['ローリーロドキン', 'LOREE RODKIN'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Tady & King', jp_names: ['タディアンドキング', 'TADY&KING', 'TADY AND KING'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'First Arrow\'s', jp_names: ['ファーストアローズ', 'FIRST ARROWS', 'FIRST ARROW\'S'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Arizona Freedom', jp_names: ['アリゾナフリーダム', 'ARIZONA FREEDOM'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Wing Rock', jp_names: ['ウイングロック', 'WING ROCK'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Cody Sanderson', jp_names: ['コディサンダーソン', 'CODY SANDERSON'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Stop Light Co.', jp_names: ['ストップライト', 'STOP LIGHT'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Ken Kikuchi', jp_names: ['ケンキクチ', 'KEN KIKUCHI'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Crazy Pig', jp_names: ['クレイジーピッグ', 'CRAZY PIG'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Buccellati', jp_names: ['ブチェラッティ', 'BUCCELLATI'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Roberto Coin', jp_names: ['ロベルトコイン', 'ROBERTO COIN'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Marco Bicego', jp_names: ['マルコビチェゴ', 'MARCO BICEGO'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Pasquale Bruni', jp_names: ['パスクワーレブルーニ', 'PASQUALE BRUNI'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'FOPE', jp_names: ['フォペ', 'FOPE'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Messika', jp_names: ['メシカ', 'MESSIKA'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Dinh Van', jp_names: ['ディンヴァン', 'DINH VAN'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Repossi', jp_names: ['レポシ', 'REPOSSI'], country: 'Monaco', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Les Nereides', jp_names: ['レネレイド', 'レ・ネレイド', 'LES NEREIDES'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Gas Bijoux', jp_names: ['ガスビジュー', 'GAS BIJOUX'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'APM Monaco', jp_names: ['APMモナコ', 'APM MONACO'], country: 'Monaco', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'De Beers', jp_names: ['デビアス', 'DE BEERS'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Stephen Webster', jp_names: ['スティーブンウェブスター', 'STEPHEN WEBSTER'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Shaun Leane', jp_names: ['ショーンリーン', 'SHAUN LEANE'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Monica Vinader', jp_names: ['モニカヴィナダー', 'MONICA VINADER'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Alexander McQueen', jp_names: ['アレキサンダーマックイーン', 'アレクサンダーマックイーン', 'ALEXANDER MCQUEEN'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Garrard', jp_names: ['ガラード', 'GARRARD'], country: 'United Kingdom', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Thomas Sabo', jp_names: ['トーマスサボ', 'THOMAS SABO'], country: 'Germany', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Trollbeads', jp_names: ['トロールビーズ', 'TROLLBEADS'], country: 'Denmark', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Maria Black', jp_names: ['マリアブラック', 'MARIA BLACK'], country: 'Denmark', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Ole Lynggaard Copenhagen', jp_names: ['オーレリンガード', 'OLE LYNGGAARD'], country: 'Denmark', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Wellendorff', jp_names: ['ウェレンドルフ', 'WELLENDORFF'], country: 'Germany', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'UNOde50', jp_names: ['ウノデ50', 'UNODE50', 'UNO DE 50'], country: 'Spain', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'TOUS', jp_names: ['トウス', 'TOUS'], country: 'Spain', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Grosse', jp_names: ['グロッセ', 'GROSSE'], country: 'Germany', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Alexis Bittar', jp_names: ['アレクシスビッター', 'ALEXIS BITTAR'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Kendra Scott', jp_names: ['ケンドラスコット', 'KENDRA SCOTT'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Spinelli Kilcollin', jp_names: ['スピネッリキルコリン', 'SPINELLI KILCOLLIN'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Alex and Ani', jp_names: ['アレックスアンドアニ', 'ALEX AND ANI'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Stephen Dweck', jp_names: ['スティーブンデュエック', 'STEPHEN DWECK'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Miriam Haskell', jp_names: ['ミリアムハスケル', 'MIRIAM HASKELL'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Trifari', jp_names: ['トリファリ', 'TRIFARI'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Monet', jp_names: ['モネ', 'MONET'], country: 'United States', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Abheri', jp_names: ['アベリ', 'ABHERI'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Gimel', jp_names: ['ギメル', 'GIMEL'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Kataoka', jp_names: ['カタオカ', 'KATAOKA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Take-Up', jp_names: ['テイクアップ', 'TAKE-UP', 'TAKEUP'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Pola', jp_names: ['ポーラ', 'POLA'], country: 'Japan', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Prada', jp_names: ['プラダ', 'PRADA'], country: 'Italy', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Saint Laurent', jp_names: ['サンローラン', 'SAINT LAURENT', 'YSL', 'イヴサンローラン'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Maison Margiela', jp_names: ['メゾンマルジェラ', 'マルジェラ', 'MAISON MARGIELA', 'MARTIN MARGIELA', 'マルタンマルジェラ'], country: 'France', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  ...
  // === Musical Instruments ===
  {name: 'Fender', jp_names: ['フェンダー', 'FENDER'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Gibson', jp_names: ['ギブソン', 'GIBSON'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Ibanez', jp_names: ['アイバニーズ', 'IBANEZ'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Yamaha', jp_names: ['ヤマハ', 'YAMAHA'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Roland', jp_names: ['ローランド', 'ROLAND'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Boss', jp_names: ['ボス', 'BOSS'], country: 'Japan', parent_brand: 'Roland', category: ['Musical Instruments']},
  {name: 'Korg', jp_names: ['コルグ', 'KORG'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'ESP', jp_names: ['イーエスピー', 'ESP'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Martin', jp_names: ['マーティン', 'マーチン', 'MARTIN'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Taylor', jp_names: ['テイラー', 'TAYLOR'], country: 'United States', category: ['Musical Instruments']},
  {name: 'PRS', jp_names: ['ポールリードスミス', 'PRS', 'PAUL REED SMITH'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Rickenbacker', jp_names: ['リッケンバッカー', 'RICKENBACKER'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Gretsch', jp_names: ['グレッチ', 'GRETSCH'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Epiphone', jp_names: ['エピフォン', 'EPIPHONE'], country: 'United States', parent_brand: 'Gibson', category: ['Musical Instruments']},
  {name: 'Squier', jp_names: ['スクワイヤー', 'SQUIER'], country: 'United States', parent_brand: 'Fender', category: ['Musical Instruments']},
  {name: 'Music Man', jp_names: ['ミュージックマン', 'MUSIC MAN', 'ERNIE BALL'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Jackson', jp_names: ['ジャクソン', 'JACKSON'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Charvel', jp_names: ['シャーベル', 'CHARVEL'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Tokai', jp_names: ['トーカイ', 'TOKAI', '東海楽器'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Fujigen', jp_names: ['フジゲン', 'FUJIGEN', 'FGN'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Greco', jp_names: ['グレコ', 'GRECO'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Fernandes', jp_names: ['フェルナンデス', 'FERNANDES'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Takamine', jp_names: ['タカミネ', 'TAKAMINE'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Aria', jp_names: ['アリア', 'ARIA'], country: 'Japan', category: ['Musical Instruments']},
  {name: 'Schecter', jp_names: ['シェクター', 'SCHECTER'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Suhr', jp_names: ['サー', 'SUHR'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Tom Anderson', jp_names: ['トムアンダーソン', 'TOM ANDERSON'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Sadowsky', jp_names: ['サドウスキー', 'SADOWSKY'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Lakland', jp_names: ['レイクランド', 'LAKLAND'], country: 'United States', category: ['Musical Instruments']},
  ...
  {name: 'Line 6', jp_names: ['ライン6', 'LINE 6', 'LINE6'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Marshall', jp_names: ['マーシャル', 'MARSHALL'], country: 'United Kingdom', category: ['Musical Instruments']},
  {name: 'Vox', jp_names: ['ヴォックス', 'VOX'], country: 'United Kingdom', category: ['Musical Instruments']},
  {name: 'Mesa Boogie', jp_names: ['メサブギー', 'MESA BOOGIE', 'MESA'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Moog', jp_names: ['モーグ', 'MOOG'], country: 'United States', category: ['Musical Instruments']},
  {name: 'Kemper', jp_names: ['ケンパー', 'KEMPER'], country: 'Germany', category: ['Musical Instruments']},
