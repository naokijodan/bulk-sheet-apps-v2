...
function resolveFieldValue_(fieldName, tag, title, brandInfo, category, description, data) {
  ...
  switch (fieldName) {
    ...
    case 'Country of Origin':
      if (category === 'Video Games' || category === 'Video Game Consoles' || category === 'Trading Cards' || category === 'Japanese Dolls' || category === 'Japanese Swords' || category === 'Tea Ceremony' || category === 'Bonsai') return 'Japan';
