...
var IS_BRAND_DICT = [
  ...
  {name: 'Tiffany & Co.', jp_names: ['ティファニー', 'TIFFANY', 'TIFFANY&CO'], country: 'USA', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  ...
  {name: 'Harry Winston', jp_names: ['ハリーウィンストン', 'HARRY WINSTON'], country: 'USA', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  ...
  {name: 'Graff', jp_names: ['グラフ', 'GRAFF'], country: 'UK', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  ...
  {name: 'Chrome Hearts', jp_names: ['クロムハーツ', 'CHROME HEARTS'], country: 'USA', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'David Yurman', jp_names: ['デヴィッドユーマン', 'DAVID YURMAN'], country: 'USA', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'John Hardy', jp_names: ['ジョンハーディ', 'JOHN HARDY'], country: 'Indonesia', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  {name: 'Vivienne Westwood', jp_names: ['ヴィヴィアンウエストウッド', 'VIVIENNE WESTWOOD'], country: 'UK', category: ['Rings', 'Necklaces', 'Bracelets', 'Earrings']},
  ...
  {name: 'Burberry', jp_names: ['バーバリー', 'BURBERRY'], country: 'UK', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Dunhill', jp_names: ['ダンヒル', 'DUNHILL'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Coach', jp_names: ['コーチ', 'COACH'], country: 'USA', category: ['Handbags', 'Wallets']},
  {name: 'Michael Kors', jp_names: ['マイケルコース', 'マイケル・コース', 'MICHAEL KORS'], country: 'USA', category: ['Handbags', 'Wallets']},
  {name: 'Kate Spade', jp_names: ['ケイトスペード', 'ケイト・スペード', 'KATE SPADE'], country: 'USA', category: ['Handbags', 'Wallets']},
  {name: 'Marc Jacobs', jp_names: ['マークジェイコブス', 'マーク・ジェイコブス', 'MARC JACOBS'], country: 'USA', category: ['Handbags', 'Wallets']},
  {name: 'Tory Burch', jp_names: ['トリーバーチ', 'TORY BURCH'], country: 'USA', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Vivienne Westwood', jp_names: ['ヴィヴィアンウエストウッド', 'ヴィヴィアン・ウエストウッド', 'VIVIENNE WESTWOOD'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Paul Smith', jp_names: ['ポールスミス', 'ポール・スミス', 'PAUL SMITH'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Stella McCartney', jp_names: ['ステラマッカートニー', 'ステラ・マッカートニー', 'STELLA MCCARTNEY'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Jimmy Choo', jp_names: ['ジミーチュウ', 'JIMMY CHOO'], country: 'UK', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Tumi', jp_names: ['トゥミ', 'TUMI'], country: 'USA', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Mulberry', jp_names: ['マルベリー', 'MULBERRY'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Alexander McQueen', jp_names: ['アレキサンダーマックイーン', 'ALEXANDER MCQUEEN'], country: 'UK', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Whitehouse Cox', jp_names: ['ホワイトハウスコックス', 'WHITEHOUSE COX'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Anteprima', jp_names: ['アンテプリマ', 'ANTEPRIMA'], country: 'Italy', category: ['Handbags', 'Wallets']},
  {name: 'Anya Hindmarch', jp_names: ['アニヤハインドマーチ', 'ANYA HINDMARCH'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Mansur Gavriel', jp_names: ['マンサーガブリエル', 'MANSUR GAVRIEL'], country: 'USA', category: ['Handbags', 'Wallets']},
  {name: 'Felisi', jp_names: ['フェリージ', 'FELISI'], country: 'Italy', category: ['Handbags', 'Wallets']},
  {name: 'Glenroyal', jp_names: ['グレンロイヤル', 'GLENROYAL'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Ettinger', jp_names: ['エッティンガー', 'ETTINGER'], country: 'UK', category: ['Handbags', 'Wallets']},
  {name: 'Smythson', jp_names: ['スマイソン', 'SMYTHSON'], country: 'UK', category: ['Handbags', 'Wallets']},
  ...
  {name: 'Engineered Garments', jp_names: ['エンジニアードガーメンツ', 'ENGINEERED GARMENTS'], country: 'USA', category: ['Clothing']},
  ...
  {name: 'Rick Owens', jp_names: ['リックオウエンス', 'RICK OWENS'], country: 'USA', category: ['Clothing']},
  {name: 'Chrome Hearts', jp_names: ['クロムハーツ', 'CHROME HEARTS'], country: 'USA', category: ['Clothing']},
  ...
  {name: 'Burberry', jp_names: ['バーバリー', 'BURBERRY'], country: 'UK', category: ['Clothing']},
  {name: 'Ralph Lauren', jp_names: ['ラルフローレン', 'RALPH LAUREN', 'POLO RALPH LAUREN'], country: 'USA', category: ['Clothing']},
  ...
  {name: 'Vivienne Westwood', jp_names: ['ヴィヴィアンウエストウッド', 'VIVIENNE WESTWOOD'], country: 'UK', category: ['Clothing']},
  {name: 'Paul Smith', jp_names: ['ポールスミス', 'PAUL SMITH'], country: 'UK', category: ['Clothing']},
  ...
  // === Shoes ===
  {name: 'Nike', jp_names: ['ナイキ', 'NIKE'], country: 'USA', category: ['Shoes']},
  {name: 'Adidas', jp_names: ['アディダス', 'ADIDAS'], country: 'Germany', category: ['Shoes']},
  {name: 'New Balance', jp_names: ['ニューバランス', 'NEW BALANCE', 'NB'], country: 'USA', category: ['Shoes']},
  {name: 'Asics', jp_names: ['アシックス', 'ASICS'], country: 'Japan', category: ['Shoes']},
  {name: 'Converse', jp_names: ['コンバース', 'CONVERSE'], country: 'USA', category: ['Shoes']},
  {name: 'Puma', jp_names: ['プーマ', 'PUMA'], country: 'Germany', category: ['Shoes']},
  {name: 'Vans', jp_names: ['バンズ', 'VANS'], country: 'USA', category: ['Shoes']},
  {name: 'Onitsuka Tiger', jp_names: ['オニツカタイガー', 'ONITSUKA TIGER'], country: 'Japan', category: ['Shoes']},
  {name: 'Reebok', jp_names: ['リーボック', 'REEBOK'], country: 'USA', category: ['Shoes']},
  {name: 'Alden', jp_names: ['オールデン', 'ALDEN'], country: 'USA', category: ['Shoes']},
  {name: 'Church\'s', jp_names: ['チャーチ', 'CHURCHS', 'CHURCH\'S'], country: 'UK', category: ['Shoes']},
  {name: 'Crockett & Jones', jp_names: ['クロケットアンドジョーンズ', 'クロケット&ジョーンズ', 'CROCKETT & JONES'], country: 'UK', category: ['Shoes']},
  {name: 'Tricker\'s', jp_names: ['トリッカーズ', 'TRICKERS', 'TRICKER\'S'], country: 'UK', category: ['Shoes']},
  {name: 'Allen Edmonds', jp_names: ['アレンエドモンズ', 'ALLEN EDMONDS'], country: 'USA', category: ['Shoes']},
  {name: 'John Lobb', jp_names: ['ジョンロブ', 'JOHN LOBB'], country: 'UK', category: ['Shoes']},
  {name: 'Edward Green', jp_names: ['エドワードグリーン', 'EDWARD GREEN'], country: 'UK', category: ['Shoes']},
  {name: 'Red Wing', jp_names: ['レッドウィング', 'RED WING', 'レッドウイング'], country: 'USA', category: ['Shoes']},
  {name: 'Timberland', jp_names: ['ティンバーランド', 'TIMBERLAND'], country: 'USA', category: ['Shoes']},
  {name: 'Dr. Martens', jp_names: ['ドクターマーチン', 'DR. MARTENS', 'DR MARTENS'], country: 'UK', category: ['Shoes']},
  ...
  {name: 'UGG', jp_names: ['アグ', 'UGG'], country: 'USA', category: ['Shoes']},
  ...
  {name: 'Jimmy Choo', jp_names: ['ジミーチュウ', 'JIMMY CHOO'], country: 'UK', category: ['Shoes']},
  ...
  {name: 'White\'s Boots', jp_names: ['ホワイツブーツ', 'WHITES BOOTS', 'WHITE\'S BOOTS'], country: 'USA', category: ['Shoes']},
  {name: 'Chippewa', jp_names: ['チペワ', 'CHIPPEWA'], country: 'USA', category: ['Shoes']},
  {name: 'Wolverine', jp_names: ['ウルヴァリン', 'WOLVERINE'], country: 'USA', category: ['Shoes']},
  {name: 'Danner', jp_names: ['ダナー', 'DANNER'], country: 'USA', category: ['Shoes']},
  ...
  {name: 'Saucony', jp_names: ['サッカニー', 'SAUCONY'], country: 'USA', category: ['Shoes']},
  {name: 'Mizuno', jp_names: ['ミズノ', 'MIZUNO'], country: 'Japan', category: ['Shoes']},
  {name: 'Hoka', jp_names: ['ホカ', 'HOKA', 'HOKA ONE ONE'], country: 'USA', category: ['Shoes']},
  ...
  {name: 'McIntosh', jp_names: ['マッキントッシュ', 'MCINTOSH'], country: 'USA', category: ['Electronics']},
  {name: 'Mark Levinson', jp_names: ['マークレビンソン', 'MARK LEVINSON'], country: 'USA', category: ['Electronics']},
  {name: 'Bowers & Wilkins', jp_names: ['B&W', 'ビーアンドダブリュー', 'BOWERS & WILKINS', 'B&W'], country: 'UK', category: ['Electronics']},
  {name: 'Krell', jp_names: ['クレル', 'KRELL'], country: 'USA', category: ['Electronics']},
  {name: 'JBL', jp_names: ['ジェービーエル', 'JBL'], country: 'USA', category: ['Electronics']},
  {name: 'Tannoy', jp_names: ['タノイ', 'TANNOY'], country: 'UK', category: ['Electronics']},
  {name: 'KEF', jp_names: ['ケフ', 'KEF'], country: 'UK', category: ['Electronics']},
  ...
  {name: 'Linn', jp_names: ['リン', 'LINN'], country: 'UK', category: ['Electronics']},
  {name: 'Bang & Olufsen', jp_names: ['バングアンドオルフセン', 'B&O', 'BANG & OLUFSEN'], country: 'Denmark', category: ['Electronics']},
  {name: 'Pass Labs', jp_names: ['パスラボ', 'PASS LABS'], country: 'USA', category: ['Electronics']},
  {name: 'Focal', jp_names: ['フォーカル', 'FOCAL'], country: 'France', category: ['Electronics']},
  {name: 'Harbeth', jp_names: ['ハーベス', 'HARBETH'], country: 'UK', category: ['Electronics']},
  ...
  {name: 'Shure', jp_names: ['シュア', 'SHURE'], country: 'USA', category: ['Electronics']},
  {name: 'Campfire Audio', jp_names: ['キャンプファイヤーオーディオ', 'CAMPFIRE AUDIO'], country: 'USA', category: ['Electronics']},
  {name: 'Hifiman', jp_names: ['ハイファイマン', 'HIFIMAN'], country: 'China', category: ['Electronics']},
  {name: 'Audeze', jp_names: ['オーデジー', 'AUDEZE'], country: 'USA', category: ['Electronics']},
  {name: 'Grado', jp_names: ['グラド', 'GRADO'], country: 'USA', category: ['Electronics']},
  {name: 'Bose', jp_names: ['ボーズ', 'BOSE'], country: 'USA', category: ['Electronics']},
  {name: 'Beats', jp_names: ['ビーツ', 'BEATS'], country: 'USA', category: ['Electronics']},
  ...
  {name: 'Dyson', jp_names: ['ダイソン', 'DYSON'], country: 'UK', category: ['Electronics']},
  {name: 'iRobot', jp_names: ['アイロボット', 'IROBOT', 'ルンバ', 'ROOMBA'], country: 'USA', category: ['Electronics']},

  // === Golf (Club Makers) ===
  {name: 'Titleist', jp_names: ['タイトリスト', 'TITLEIST'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'TaylorMade', jp_names: ['テーラーメイド', 'TAYLORMADE'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Callaway', jp_names: ['キャロウェイ', 'CALLAWAY'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Ping', jp_names: ['ピン', 'PING'], country: 'USA', category: ['Golf', 'Golf Heads']},
  ...
  {name: 'Cobra', jp_names: ['コブラ', 'COBRA'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Cleveland', jp_names: ['クリーブランド', 'CLEVELAND'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Scotty Cameron', jp_names: ['スコッティキャメロン', 'スコッティ・キャメロン', 'SCOTTY CAMERON'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Odyssey', jp_names: ['オデッセイ', 'ODYSSEY'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Bettinardi', jp_names: ['ベティナルディ', 'BETTINARDI'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'PXG', jp_names: ['ピーエックスジー', 'PXG'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Vokey', jp_names: ['ボーケイ', 'VOKEY'], country: 'USA', parent_brand: 'Titleist', category: ['Golf', 'Golf Heads']},
  // Golf Shaft Makers
  ...
  {name: 'True Temper', jp_names: ['トゥルーテンパー', 'TRUE TEMPER'], country: 'USA', category: ['Golf']},
  {name: 'UST Mamiya', jp_names: ['マミヤ', 'UST MAMIYA', 'UST'], country: 'Japan', category: ['Golf']},
  {name: 'KBS', jp_names: ['KBS', 'ケービーエス'], country: 'USA', category: ['Golf']},
  {name: 'Aerotech', jp_names: ['エアロテック', 'AEROTECH'], country: 'USA', category: ['Golf']},
  // Golf Other Brands
  ...
  {name: 'Piretti', jp_names: ['ピレッティ', 'PIRETTI'], country: 'USA', category: ['Golf', 'Golf Heads']},
  {name: 'Toulon', jp_names: ['トゥーロン', 'TOULON'], country: 'USA', parent_brand: 'Odyssey', category: ['Golf', 'Golf Heads']},

  // === Musical Instruments ===
  {name: 'Fender', jp_names: ['フェンダー', 'FENDER'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Gibson', jp_names: ['ギブソン', 'GIBSON'], country: 'USA', category: ['Musical Instruments']},
  ...
  {name: 'Martin', jp_names: ['マーティン', 'マーチン', 'MARTIN'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Taylor', jp_names: ['テイラー', 'TAYLOR'], country: 'USA', category: ['Musical Instruments']},
  {name: 'PRS', jp_names: ['ポールリードスミス', 'PRS', 'PAUL REED SMITH'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Rickenbacker', jp_names: ['リッケンバッカー', 'RICKENBACKER'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Gretsch', jp_names: ['グレッチ', 'GRETSCH'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Epiphone', jp_names: ['エピフォン', 'EPIPHONE'], country: 'USA', parent_brand: 'Gibson', category: ['Musical Instruments']},
  {name: 'Squier', jp_names: ['スクワイヤー', 'SQUIER'], country: 'USA', parent_brand: 'Fender', category: ['Musical Instruments']},
  {name: 'Music Man', jp_names: ['ミュージックマン', 'MUSIC MAN', 'ERNIE BALL'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Jackson', jp_names: ['ジャクソン', 'JACKSON'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Charvel', jp_names: ['シャーベル', 'CHARVEL'], country: 'USA', category: ['Musical Instruments']},
  ...
  {name: 'Schecter', jp_names: ['シェクター', 'SCHECTER'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Suhr', jp_names: ['サー', 'SUHR'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Tom Anderson', jp_names: ['トムアンダーソン', 'TOM ANDERSON'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Sadowsky', jp_names: ['サドウスキー', 'SADOWSKY'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Lakland', jp_names: ['レイクランド', 'LAKLAND'], country: 'USA', category: ['Musical Instruments']},
  ...
  {name: 'Zildjian', jp_names: ['ジルジャン', 'ZILDJIAN'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Line 6', jp_names: ['ライン6', 'LINE 6', 'LINE6'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Marshall', jp_names: ['マーシャル', 'MARSHALL'], country: 'UK', category: ['Musical Instruments']},
  {name: 'Vox', jp_names: ['ヴォックス', 'VOX'], country: 'UK', category: ['Musical Instruments']},
  {name: 'Mesa Boogie', jp_names: ['メサブギー', 'MESA BOOGIE', 'MESA'], country: 'USA', category: ['Musical Instruments']},
  {name: 'Moog', jp_names: ['モーグ', 'MOOG'], country: 'USA', category: ['Musical Instruments']},
  ...
  {name: 'Parker', jp_names: ['パーカー', 'PARKER'], country: 'UK', category: ['Pens']},
  ...
  {name: 'Cross', jp_names: ['クロス', 'CROSS'], country: 'USA', category: ['Pens']},
  {name: 'Sheaffer', jp_names: ['シェーファー', 'SHEAFFER'], country: 'USA', category: ['Pens']},
  ...
  {name: 'G-Loomis', jp_names: ['Gルーミス', 'G-LOOMIS', 'G LOOMIS'], country: 'USA', category: ['Fishing Rods']},
  {name: 'St. Croix', jp_names: ['セントクロイ', 'ST. CROIX', 'ST CROIX'], country: 'USA', category: ['Fishing Rods']},
