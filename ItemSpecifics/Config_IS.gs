...
IS_TAG_TO_CATEGORY['油彩'] = 'Art'; IS_TAG_TO_CATEGORY['シルクスクリーン'] = 'Art';
IS_TAG_TO_CATEGORY['エッチング'] = 'Art'; IS_TAG_TO_CATEGORY['彫刻'] = 'Art';
IS_TAG_TO_CATEGORY['書'] = 'Art'; IS_TAG_TO_CATEGORY['書道'] = 'Art';
IS_TAG_TO_CATEGORY['デッサン'] = 'Art'; IS_TAG_TO_CATEGORY['色紙'] = 'Art';
IS_TAG_TO_CATEGORY['短冊'] = 'Art'; IS_TAG_TO_CATEGORY['Painting'] = 'Art';
IS_TAG_TO_CATEGORY['Oil Painting'] = 'Art'; IS_TAG_TO_CATEGORY['Watercolor'] = 'Art';
IS_TAG_TO_CATEGORY['Sculpture'] = 'Art'; IS_TAG_TO_CATEGORY['Print'] = 'Art';
IS_TAG_TO_CATEGORY['Lithograph'] = 'Art'; IS_TAG_TO_CATEGORY['Etching'] = 'Art';
IS_TAG_TO_CATEGORY['Silkscreen'] = 'Art'; IS_TAG_TO_CATEGORY['Drawing'] = 'Art';
IS_TAG_TO_CATEGORY['Woodblock Print'] = 'Art'; IS_TAG_TO_CATEGORY['Calligraphy'] = 'Art';
IS_TAG_TO_CATEGORY['Mixed Media'] = 'Art'; IS_TAG_TO_CATEGORY['Giclee'] = 'Art';
...
var IS_CATEGORY_FIELDS = {
  ...
  'Figures': ['Listed By', 'Franchise', 'Character', 'Type', 'Brand', 'Scale', 'Material', 'Series/Line', 'Release Year', 'Country of Origin', 'Theme', 'Age Level', 'Features', 'Edition'],
  'Stamps': [
