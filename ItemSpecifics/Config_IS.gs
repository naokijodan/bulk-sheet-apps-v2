...
var IS_BRAND_DICT = [
  ...
  {name: 'Baume & Mercier', jp_names: ['ボーム&メルシエ', 'BAUME & MERCIER'], country: 'Switzerland'},
  {name: 'Bell & Ross', jp_names: ['ベル&ロス', 'BELL & ROSS'], country: 'France'},
  ...
  {name: 'G-Shock', jp_names: ['Gショック', 'G-SHOCK'], country: 'Japan'},
  ...
  {name: 'Jaeger-LeCoultre', jp_names: ['ジャガールクルト', 'JAEGER-LECOULTRE'], country: 'Switzerland'},
  ...
  {name: 'Tiffany & Co.', jp_names: ['ティファニー', 'TIFFANY & CO.'], country: 'USA'},
  {name: 'Van Cleef & Arpels', jp_names: ['ヴァン クリーフ＆アーペル', 'VAN CLEEF & ARPELS'], country: 'France'},
  ...
  {name: 'Bang & Olufsen', jp_names: ['バング&オルフセン', 'BANG & OLUFSEN'], country: 'Denmark'},
  ...
  {name: 'Gen-emon', jp_names: ['源右衛門', 'GEN-EMON'], country: 'Japan'},
  ...
  {name: 'Girard-Perregaux', jp_names: ['ジラールペルゴ', 'GIRARD-PERREGAUX'], country: 'Switzerland'},
  ...
  {name: 'L.L.Bean', jp_names: ['エルエルビーン', 'L.L.BEAN'], country: 'USA'},
  ...
  {name: 'Off-White', jp_names: ['オフホワイト', 'OFF-WHITE'], country: 'Italy'},
  ...
  {name: 'Tady & King', jp_names: ['タディアンドキング', 'TADY & KING'], country: 'Japan'},
  ...
  {name: 'master-piece', jp_names: ['マスターピース', 'MASTER-PIECE'], country: 'Japan'},
  ...
  {name: 'Crockett & Jones', jp_names: ['クロケット＆ジョーンズ', 'CROCKETT & JONES'], country: 'UK'},
  {name: 'Dr. Martens', jp_names: ['ドクターマーチン', 'DR. MARTENS'], country: 'UK'},
  ...
  {name: 'Audio-Technica', jp_names: ['オーディオテクニカ', 'AUDIO-TECHNICA'], country: 'Japan'},
  ...
  {name: 'Cardfight!! Vanguard', jp_names: ['カードファイト!! ヴァンガード', 'VANGUARD'], country: 'Japan'},
  ...
  {name: 'Yu-Gi-Oh', jp_names: ['遊戯王', 'YU-GI-OH'], country: 'Japan'},
  ...
  {name: 'S.H.Figuarts', jp_names: ['S.H.フィギュアーツ', 'S.H.FIGUARTS'], country: 'Japan'},
