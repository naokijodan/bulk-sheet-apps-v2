...
var IS_INITIAL_DATA = [
  ...
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Style', field_type: 'optional', priority: 10, notes: '振袖/留袖/訪問着/浴衣等' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Era', field_type: 'optional', priority: 11, notes: '明治/大正/昭和等' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Department', field_type: 'optional', priority: 12, notes: 'レディース/メンズ/キッズ' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Occasion', field_type: 'optional', priority: 13, notes: '成人式/婚礼/茶道等' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Features', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Vintage', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Theme', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Designer', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Number of Pieces', field_type: 'optional', priority: 18, notes: '着物・帯・小物等のセット数' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Handmade', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Set Includes', field_type: 'optional', priority: 20, notes: '着物・帯・帯締め等セット内容' },
  { category: 'Kimono', tag_jp: '着物,和装,振袖,留袖,訪問着,浴衣,帯,袴,小紋,紬,付下げ,羽織,色無地,反物,草履,下駄,名古屋帯,袋帯,半幅帯', field_name: 'Official/Unofficial', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Color', field_type: 'recommended', priority: 11, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Style', field_type: 'optional', priority: 12, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Season', field_type: 'optional', priority: 13, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Number of Pieces', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Technique', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'School/Maker', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Department', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Features', field_type: 'optional', priority: 18, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Vintage', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Dimensions', field_type: 'optional', priority: 20, notes: '縦×横×高さ' },
  { category: 'Tea Ceremony', tag_jp: '茶道具,茶碗,茶入,棗,茶杓,水指,建水,風炉,釜,蓋置,香合,花入,茶筅,柄杓,菓子器,炉縁', field_name: 'Occasion', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Color', field_type: 'optional', priority: 11, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Features', field_type: 'optional', priority: 12, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Department', field_type: 'optional', priority: 13, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Theme', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Vintage', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Occasion', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Collection', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Official/Unofficial', field_type: 'optional', priority: 18, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Number of Pieces', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Series', field_type: 'optional', priority: 20, notes: '' },
  { category: 'Buddhist Art', tag_jp: '仏像,仏具,仏教美術,神具,木彫,銅像,観音,如来,数珠,木魚', field_name: 'Pattern', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Character', field_type: 'recommended', priority: 11, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Series', field_type: 'recommended', priority: 12, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Franchise', field_type: 'recommended', priority: 13, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Department', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Theme', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Features', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Official/Unofficial', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Vintage', field_type: 'optional', priority: 18, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Number of Volumes', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Occasion', field_type: 'optional', priority: 20, notes: '' },
  { category: 'Manga', tag_jp: '漫画,マンガ,コミック,単行本,文庫本,全巻セット,初版,同人誌,画集', field_name: 'Style', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Number of Pieces', field_type: 'optional', priority: 8, notes: 'セット本数' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Material', field_type: 'optional', priority: 9, notes: 'Stainless Steel / Silver等' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Color', field_type: 'optional', priority: 10, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Number of Place Settings', field_type: 'optional', priority: 11, notes: '対応人数分のセット数' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Features', field_type: 'optional', priority: 12, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Department', field_type: 'optional', priority: 13, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Theme', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Series', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Occasion', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Vintage', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Set Includes', field_type: 'optional', priority: 18, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Era', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Designer', field_type: 'optional', priority: 20, notes: '' },
  { category: 'Flatware', tag_jp: 'カトラリー,スプーン,フォーク,ナイフ', field_name: 'Official/Unofficial', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Department', field_type: 'optional', priority: 8, notes: '男の子/女の子/ユニセックス' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Features', field_type: 'optional', priority: 9, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Age Group', field_type: 'optional', priority: 10, notes: '対象年齢・月齢（Newborn / 0-6M等）' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Gender', field_type: 'optional', priority: 11, notes: '対象性別（Boys / Girls / Unisex）' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Theme', field_type: 'optional', priority: 12, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Series', field_type: 'optional', priority: 13, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Franchise', field_type: 'optional', priority: 14, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Occasion', field_type: 'optional', priority: 15, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Vintage', field_type: 'optional', priority: 16, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Style', field_type: 'optional', priority: 17, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Official/Unofficial', field_type: 'optional', priority: 18, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Era', field_type: 'optional', priority: 19, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Pattern', field_type: 'optional', priority: 20, notes: '' },
  { category: 'Baby', tag_jp: 'ベビー,ベビーシューズ,ラトル,ベビー用品', field_name: 'Number of Pieces', field_type: 'optional', priority: 21, notes: '' },
  ...
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Size', field_type: 'required', priority: 11, notes: 'eBay mandatory。S / M / L / XL / One Size等' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Trim Material', field_type: 'recommended', priority: 12, notes: 'Leather / Metal / Fabric等' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Lining Material', field_type: 'recommended', priority: 13, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Features', field_type: 'recommended', priority: 14, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Season', field_type: 'recommended', priority: 15, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Fabric Type', field_type: 'recommended', priority: 16, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Performance/Activity', field_type: 'recommended', priority: 17, notes: 'Western / Military / Casual / Sports等' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Vintage', field_type: 'recommended', priority: 18, notes: 'Yes / No' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Occasion', field_type: 'recommended', priority: 19, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Era', field_type: 'recommended', priority: 20, notes: '' },
  { category: 'Belt Buckles', tag_jp: 'ベルトバックル', field_name: 'Designer', field_type: 'recommended', priority: 21, notes: '' },
...
var IS_CATEGORY_FIELDS = {
  ...
  'Flatware': [
    'Brand', 'Type', 'Pattern', 'Composition', 'Style', 'Age', 'Country of Origin',
    'Number of Pieces', 'Material', 'Color', 'Number of Place Settings', 'Features', 'Department', 'Theme',
    'Series', 'Occasion', 'Vintage', 'Set Includes', 'Era', 'Designer', 'Official/Unofficial',
  ],
  'Baby': [
  ...
  'Tea Ceremony': [
    'Type', 'Material', 'Maker', 'Origin/Kiln', 'Era/Period', 'Box Type', 'Size', 'Motif/Subject', 'Pattern', 'Country of Origin',
  ...
  'Manga': [
    'Title', 'Author', 'Publisher', 'Language', 'Format', 'Volume/Set', 'Genre', 'Publication Year', 'Edition', 'Country of Origin',
    'Character', 'Series', 'Franchise', 'Department', 'Theme', 'Features', 'Official/Unofficial', 'Vintage', 'Number of Volumes', 'Occasion', 'Style',
  ],
  'Anime': [
    'Character',           //  1. 必須
    'Franchise',           //  2. 必須
