...
var IS_BRAND_DICT = [
  ...
  {name: 'Aikon', jp_names: ['アイコン', 'AIKON'], country: 'Switzerland', parent_brand: 'Maurice Lacroix', category: ['Watches']},
  ...
  {name: 'Tissot Super Sport', jp_names: ['スーパースポーツ', 'SUPER SPORT'], country: 'Switzerland', parent_brand: 'Tissot', category: ['Watches']},
...
var IS_CATEGORY_FIELDS = {
  'Watches':       ['Brand', 'Model', 'Type', 'Movement', 'Case Material', 'Case Size', 'Wrist Size', 'Dial Color', 'Department', 'Country/Region of Manufacture'],
