...
var IS_BRAND_DICT = [
  ...
  {name: 'Baby-G', jp_names: ['ベビーG', 'BABY-G', 'BABYG'], country: 'Japan', parent_brand: 'Casio', category: ['Watches']},
  ...
  {name: 'King Seiko', jp_names: ['キングセイコー', 'KING SEIKO'], country: 'Japan', parent_brand: 'Seiko', category: ['Watches']},
  ...
  {name: 'Seiko 5', jp_names: ['セイコー5', 'SEIKO 5', 'セイコーファイブ'], country: 'Japan', parent_brand: 'Seiko', category: ['Watches']},
  ...
  {name: 'Seiko Lukia', jp_names: ['ルキア', 'LUKIA'], country: 'Japan', parent_brand: 'Seiko', category: ['Watches']},
