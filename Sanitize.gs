...
var SANITIZE_PROMPT_DEFAULT_ = [
  ...
  '=== 正解例 ===',
  '',
  '入力タイトル: タグホイヤー TAG Heuer プロフェッショナル 2000 メンズ 黒 WK1110 時計 クォーツ 稼動品',
  '入力説明: --商品の仕様-- ●モデル名 [タグ・ホイヤー プロフェッショナル メンズ] ●腕周り：16.5cm(最長) ●素材：SS ●サイズ径：W38mm ●ムーブ：クォーツ（電池） ●文字盤色：ブラック ●動作：稼動品 ●付属品：なし --おすすめポイント！-- ■スイスの高級時計メーカー『タグ・ホイヤー（TAG Heuer）』。 ■スポーティな風合いを踏襲し、ドレスウォッチとしても使える汎用性の高いメンズモデル『プロフェッショナル』。 ■ブラッシュ(艶消し)仕上げのクールなデザイン。 ■ダンディな黒文字盤との組み合わせはレスポンスがよく装着感も良好です。 ■日常使いから特別な場面まで幅広く活躍します。 ◎逆回転防止ベゼル。 ◎ねじ込みリューズロック。 ◎カレンダー。 ◎スクリューバック。 ◎フリップロックつきDバックル。 ---【商品状態】--- ☆外装、クリーニング済、小キズはありますが比較的キレイです。 ☆夜光にヒビがあります。 ☆ブレスサイズはコマ調整にて短くする事ができます。 ☆中古商品のため防水性の保障はつきませんのでご了承ください。 ※商品画像はお客様のモニター環境によっては色調が異なって見える場合がございますのでご了承ください。 --ランク-- ★本品のランクは【7】です。 [N] 新品 [9] 未使用品もしくは展示品 [8] 使用感のない超美品 [7] 微小な使用感、微小な生活傷程度の難がある [6] 使用感はあるものの奇麗な状態 [5] やや傷み・難があるが通常の使用には差し障り無い状態 [4] 難あり、一部欠陥があるが大部分で使用は可能 [3] 要リペア（修理）の品 [2〜1] - ※トラブル防止のため、ご購入者様であっても、画像・文章の無断転載はお断りいたします。',
  '',
  '正解タイトル: タグホイヤー TAG Heuer プロフェッショナル 2000 メンズ 黒 WK1110 時計 クォーツ 稼動品',
  '正解説明: タグ・ホイヤー プロフェッショナル メンズ 腕周り：16.5cm SS W38mm クォーツ（電池） ブラック 稼動品 付属品：なし 逆回転防止ベゼル ねじ込みリューズロック カレンダー スクリューバック フリップロックつきDバックル 小キズはありますが比較的キレイです。夜光にヒビがあります。ブレスサイズはコマ調整にて短くする事ができます。',
  '',
  '=== 正解例ここまで ===',
  '',
  '出力形式:',
