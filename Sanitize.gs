...
var SANITIZE_FIELDS_ = {
  ...
  'Hair Accessories': [
    'タイプ', 'ブランド', '色', '素材', '対象', 'テーマ', '用途', '髪質', '特徴', '製造国',
    'スタイル', 'ヴィンテージ', '年代', 'シーズン', 'シリーズ', '公式/非公式',
    'フランチャイズ', 'キャラクター', '模様', 'コレクション', '個数',
    '付属品', 'コンディション', '故障・不具合'
  ],
  'Tie Accessories': [
    'ブランド', 'タイプ', '金属', '金属純度', '主石', '色', '素材', '対象', '製造国',
    '特徴', 'テーマ', 'スタイル', 'ヴィンテージ', '年代', '用途',
    'シリーズ', '公式/非公式', '模様', 'コレクション', '個数', '性別',
    '付属品', 'コンディション', '故障・不具合'
  ],
  'Watch Parts': [
    'ブランド', 'パーツタイプ', '素材', '対応モデル', 'サイズ', '色', '製造国',
    'タイプ', '互換ブランド', 'ムーブメントタイプ', '特徴', '仕上げ',
    'ヴィンテージ', 'シリーズ', '対象', 'テーマ', 'スタイル', '年代', '用途', '模様', '公式/非公式',
    '付属品', 'コンディション', '故障・不具合'
  ],
